...
3. Do not use any echo related commands to break Discord's ToS (e.g say, shout, ascii etc)
   - Usage of these commands are logged to our development server
5. If you don't intend on using nsfw on non nsfw channels then enable nonsfw!
